...
public class ResearchSubjectImporterTest {
	...
	public void setUp() {
		...
		divaImporter = new ResearchSubjectImporter(recordReader, fromClassicToCoraConverter,
	...
	public void testCorrectReadFromDb() {
		...
		assertEquals(subjectTypeUsedToSelect, 53);
	}
	...
	// divaImporter.importData();
	//
	// List<ClientDataElement> elementsSentToJsonConverter =
	// toJsonConverterFactory.clientDataElements;
	//
	// List<ClientDataGroup> returnedGroupsFromClassicConverter =
	// fromClassicToCoraConverter.returnedDataGroups;
	...
	// DataToJsonConverterSpy jsonConverter = (DataToJsonConverterSpy)
	// toJsonConverterFactory.factoredConverters
	// .get(index);
